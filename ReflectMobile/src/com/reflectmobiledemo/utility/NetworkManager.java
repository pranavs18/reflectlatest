package com.reflectmobiledemo.utility;
...
public class NetworkManager {
	...
	public static final String hostName="http://rewyndr-backend-dev-mngxjrypn3.elasticbeanstalk.com";
	//public static final String SOUND_HOST_NAME = "http://ec2-54-210-20-196.compute-1.amazonaws.com";
    public static final String SOUND_HOST_NAME="http://rewyndr-backend-dev-mngxjrypn3.elasticbeanstalk.com";
	...
	public static class HttpGetTask extends AsyncTask<String, Void, Void> {
		...
		private String executeRequest(String url) throws IOException {
			...
			try {
				...
				Log.d("NETWORK MANAGER" , httpUrlConnection.getResponseCode() + " ");
	...
	public static void loginViaReflect(HttpTaskHandler handler) {
		...
		try {
			...
			truefitUserData.put("first_name",firstName);
			truefitUserData.put("last_name",lastName );
			truefitUserData.put("email", emailID);
		...
		Log.d("NETWORK", "PAYLOAD SENT " + payload);
