...
public class ImageProcessor {
	...
	// The input originalbitmap is the bitmap we get from the rewyndr(LargeImage)
	...
	// This function is used to highlighted tag based on the location where user touch
	...
	public static Bitmap drawEditSquare(Bitmap originalBitmap,
		...
		int[] littleSquareXList = { upLeftX, (bottomRightX + upLeftX) / 2,
				bottomRightX, upLeftX, bottomRightX, upLeftX,
				(bottomRightX + upLeftX) / 2, bottomRightX };
		int[] littleSquareYList = { upLeftY, upLeftY, upLeftY,
				(bottomRightY + upLeftY) / 2, (bottomRightY + upLeftY) / 2,
				bottomRightY, bottomRightY, bottomRightY };
